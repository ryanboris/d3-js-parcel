...
d3.select('body').append('svg').attr('height', 2000).attr('width', 2000).selectAll('circle').data(arr.filter(function (item) {
  ...
  return d % 2 == 0 ? 10 : 10 * d;
}).attr('fill', function (d) {
  return "hsl(".concat(Math.random() * 360, ", ").concat(100 - d, "%, ").concat(d % 2 === 0 ? 20 : 70, "%)");
